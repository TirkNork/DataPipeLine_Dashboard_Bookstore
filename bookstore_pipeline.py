...
MYSQL_CONNECTION = "mysql_default"   #  connection in Airflow 
...
def get_data_from_mysql(transaction_path):
    ...
    # Using MySqlHook to connect MySQL from connection in Airflow
    mysqlserver = MySqlHook(MYSQL_CONNECTION)
    
    # Query database with Hook 
...
with DAG(
    ...
    load = GCSToBigQueryOperator(
        ...
        destination_project_dataset_table='bookstore.audible_data',
        skip_leading_rows=1,
        schema_fields=[
            {
                "mode": "NULLABLE",
    ...
    [ingest_sql, ingest_api] >> merge >> load
